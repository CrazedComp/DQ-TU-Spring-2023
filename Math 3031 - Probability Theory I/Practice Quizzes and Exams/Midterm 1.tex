...
\item [(b)] Find the probability that our sample of balls were all blue.					%normal unordered, n choose k, but #P(b)/#totalP
	...
	\end{itemize}
\item [(c)]  Find the probability that our sample of 5 balls has at least 2 blue balls. 		%sum of probabilities, dependent (without replacement), P(2g)+P(3g)P+P(4g)+P(4g)
\end{itemize}
\pagebreak
