...
\begin{itemize}
\item [(a)] We first choose an urn at random and then choose a ball randomly from the chosen urn. Find the probability that the ball is red. %conditional prob, useing \sum multiplcation rule
\end{itemize}
\textit{Solution. }
...
\textit{Solution. }\\
\begin{center}
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZABgBoBGAXVJADcBDAGwFcYkQQBfU9TXfQigDMpYtTpNW7ACJceIDNjwEiIgEziGLNohDSAegGE5vJQKIA2UZsk6QAHXsAjCAA8YUYAGpOJhX2VBZCsNGi0pXUcXd08AWl9OcQ8Ac3giUAAzACcIAFskMhAcCCRyGkZ6JxhGAAUA810sMGxYEDDbdhqACmkASgBeADpiEfI-bLyCmmKkNXLK6rqzFUbmrFb27U6eowHyWO6+oYBOU+PxnPzEMqKSxBEQCqra+pWQJpa2TYiQbq8AHyOg1OF0miDmtyQDyei1egneaw2Ei2uj+gN2-WIgzGiU4QA
\begin{tikzcd}
                                                                                          &  &  & D \arrow[rrr, "P(+|D)=.99" description]       &  &  & \boxed{+} \\
{} \arrow[rrru, "P(D)=.0001" description] \arrow[rrrd, "P(D^C)=1-P(D)=.9999" description] &  &  &                                               &  &  &           \\
                                                                                          &  &  & D^C \arrow[rrruu, "P(+|D^C)=0.1" description] &  &  & \boxed{-}
\end{tikzcd}
\end{center}
